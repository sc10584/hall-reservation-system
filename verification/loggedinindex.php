            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light p-0">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#"><i class="fa fa-fw fa-envelope"></i>contect us</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="booking.php"><i class="fa fa-fw fa-envelope"></i>booking</a>
                            </li>
                            </ul>
                            </div>
                    ...
                    <form class="justify-content-end">
                        <?php 
                            if (isset($_SESSION['logged_in']) && $_SESSION['logged_in']==TRUE) {
                                echo $_SESSION['username']." you are logged in! "."<a href='logout.php' class='link-dark'>Logout</a>";
